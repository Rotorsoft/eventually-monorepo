...
values
    ('calc-count', true, 'calculator', 'counter', 'counter', '^Calculator-.*$', 'DigitPressed', -1, 100),
    ('count-calc', true, 'counter', 'calculator', 'stateless-counter', '^Calculator-.*$', 'DigitPressed', -1, 150);
